...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">รายละเอียดรถจักรยานยนต์</li>
    </ol>
</nav>
...
<div class="row">
    <div class="col-md-6 mx-auto">
        ...
        <a href="/motorcycle-reserve/{{$detail->motorcycle_ID}}" class="btn btn-primary">จองเลย</a>
    </div>
</div>
